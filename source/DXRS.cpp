...
namespace
{
    std::unique_ptr<DXRSExampleScene> g_sample;
    HDEVNOTIFY g_hNewAudio = nullptr;
};

LPCWSTR g_szAppName = L"DXR Sandbox";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    g_sample = std::make_unique<DXRSExampleScene>();
    ...
    // Register class and create window
    {
        ...
        HWND hwnd = CreateWindowExW(0, L"DXR Sandbox", g_szAppName, WS_OVERLAPPEDWINDOW,
        ...
        g_sample->Init(hwnd, rc.right - rc.left, rc.bottom - rc.top);
    }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    auto sample = reinterpret_cast<DXRSExampleScene*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
